...
import { RouteItemContextProvider } from "../components/creatingRouteItem/routeItemContext";
    ...
    <AuthProvider>
      <div className="App">
        <Routes>
          ...
          />
          <Route
            path="/folder/:folderId/view/:fileId"
            element={
              <RequireAuth>
                <RouteItemContextProvider>
                  <DocumentView />
                </RouteItemContextProvider>
              </RequireAuth>
            }
          ...
          />
          <Route
            path="/complete-routeitem/:routeSlipId/:routeItemId"
            element={
              <RequireAuth>
                <SignDocument />
              </RequireAuth>
          ...
          />
          <Route
            path="/templates/teleworkAgreement"
            element={
              <RequireAuth>
                <TeleworkAgreement />
              </RequireAuth>
