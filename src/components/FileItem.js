...
export default function FileItem({ file, name, pending }) {
    ...
    return <div className="block bg-white  py-3 border-t">
        ...
        <div className="grid grid-cols-12 font-bold text-gray-700">
            ...
            <div className="col-span-7"> <span className="block font-semibold my-2">{fileName}</span></div>
            <div className="col-span-3">
                ...
                {!pending && file.file && file.id ? <Button to={`/folder/${file.parentFolder}/view/${file && file.id}/`} color="secondary" size="small" className="inline-flex">View</Button> : null}

            </div>
            <div className="col-span-1">
            <div className="h-10 w-10 bg-green-100 rounded-full flex items-center justify-center text-lg mx-auto">{user.profileImage}</div>
