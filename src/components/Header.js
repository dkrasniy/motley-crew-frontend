      ...
      <div className="flex-1 flex flex-col min-h-0 bg-white">
        <div className="flex-1 flex flex-col pt-4 pb-4 overflow-y-auto">
          ...
          <nav className="px-8 py-4 text-sm font-semibold text-gray-800">
            <span className="uppercase text-gray-500 font-semibold text-xs tracking-wide mb-1 block">
              Primary
            </span>
            <ul>
              <li>
                <Link
                  to="/dashboard"
                  className="hover:text-blue-500 py-2 flex items-center transition"
                >
                  {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className='w-4 h-4 text-gray-500 mr-2'><path fill="currentColor" className="fa-primary" d="M266.9 7.918C278.1-2.639 297-2.639 309.1 7.918L565.1 231.9C578.4 243.6 579.7 263.8 568.1 277.1C556.4 290.4 536.2 291.7 522.9 280.1L288 74.52L53.07 280.1C39.77 291.7 19.56 290.4 7.917 277.1C-3.72 263.8-2.372 243.6 10.93 231.9L266.9 7.918z"/><path fill="currentColor"  className="fa-secondary" d="M288 74.52L512.1 270.6L512.5 447.9C512.6 483.3 483.9 512 448.5 512H128.1C92.74 512 64.09 483.4 64.07 448L64.02 270.5L288 74.52z"/></svg> */}
                  Home
                </Link>
              </li>
              <li>
            ...
            <div className="mt-8">
              ...
              <ul>
                ...
                <li>
                  <Link
                    to="/templates/teleworkAgreement"
                    className="hover:text-blue-500 py-2 block transition "
                  >
                    Telework Agreement
                  </Link>
                ...
                <li>
                  <Link
                    to="/dashboard"
                    className="hover:text-blue-500 py-2 block transition text-blue-500"
                  >
                    Create New
                  </Link>
                </li>
        ...
        <div className="flex-shrink-0 flex px-8 py-4">
          <div>
            <Menu as="div" className="relative inline-block text-left">
              <Menu.Button>
                <div className="h-10 w-10 bg-green-100 rounded-full flex items-center justify-center text-base">
                  {user.profileImage ? user.profileImage : "🏄‍"}
                </div>

                <div className="flex items-center hover:bg-gray-50 transition py-2 rounded-xl">
                  <div>
                    <span className="block font-semibold -mb-1 text-left">
                      {user.username}
                    </span>
              ...
              >
                <Menu.Items className="origin-bottom absolute bottom-16 left-0 mt-2 w-72 rounded-md shadow-xl bg-white focus:outline-none  overflow-hidden">
                  <Menu.Item>
                    <Link
                      to="/account"
                      className="block px-4 py-4 hover:bg-gray-50 w-full text-left"
                    >
                      Account Settings
                    </Link>
                  </Menu.Item>
