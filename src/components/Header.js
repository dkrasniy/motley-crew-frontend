...
export default function Header() {
    ...
    return <header className='hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0'>
        ...
        <div className='flex-1 flex flex-col min-h-0 bg-white'>
            <div className='flex-1 flex flex-col pt-4 pb-4 overflow-y-auto'>
                ...
                <div className='px-8 py-4'>
                 ...
                 <div className='h-14 w-14 p-1 rounded-full bg-blue-500 flex items-center justify-center text-white' style={{backgroundColor: '#2563EB'}}>
                ...
                <ul>
                <li><Link to="/dashboard" className='py-1 flex items-center '>
                ...
                Home</Link></li>
                <li><Link to="/dashboard" className='py-1 block'>Outgoing</Link></li>
                <li><Link to="/dashboard" className='py-1 block'>Incoming</Link></li>
                <li><Link to="/dashboard" className='py-1 block'>Completed</Link></li>
                <li><Link to="/account" className='py-1 block'>Settings</Link></li>
                </ul>
                <div className='mt-8'>
                <span class="uppercase text-gray-500 font-semibold text-xs tracking-wide mb-1 block">Templates</span>
                <ul>
                <li><Link to="/dashboard" className='py-1 block '>Travel Expense</Link></li>
                <li><Link to="/dashboard" className='py-1 block '>Telework Agreement</Link></li>
                </ul></div>
